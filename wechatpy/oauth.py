...
class WeChatComponentOAuth(object):
    """微信第三方平台公众号 OAuth 网页授权 """
    ...
    def __init__(self, app_id, redirect_uri, component_appid,
                 scope='snsapi_base', state=''):
        """

        :param app_id: 微信公众号 app_id
        :param redirect_uri: OAuth2 redirect URI
        :param component_appid: 微信第三方平台服务方appid
        :param scope: 可选，微信公众号 OAuth2 scope，默认为 ``snsapi_base``
        :param state: 可选，微信公众号 OAuth2 state
        """
        self.app_id = app_id
    ...
    def fetch_access_token(self, code, component_access_token):
        """获取 access_token
    ...
    def refresh_access_token(self, refresh_token, component_access_token):
        """刷新 access token
